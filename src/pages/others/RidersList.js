...
import {changeRidersStatus, getAllRiders} from "../../api/rider/rider";
...
const RidersList = (props) => {
    ...
    const getUpdatedData = async () =>{
        ...
        if(res.request.status !== 200) {
            ...
            setData(newList.filter((t)=>t.user_status === props.name));
        ...
        <React.Fragment>
            ...
            <Content>
                <BlockHead size="sm">
                    <BlockBetween>
                        <BlockHeadContent>
                            <BlockTitle page>{`${props.name} Riders`}</BlockTitle>
                        </BlockHeadContent>
                        { !props.name &&
                            <BlockHeadContent>
                    ...
                    <DataTable className="card-stretch">
                        <div className="card-inner" >
                            <div className="card-title-group">
                                    ...
                                    <h5 className="title">{`${props.name} Rider List`}</h5>
                                        </div>
                                    </Box>
                            ...
                            {currentItems.length > 0
                                ? currentItems.map((item) => (
                                    <DataTableItem key={item.id}>
                                        ...
                                        <DataTableRow size="md">
                                            <span className="tb-sub text-primary">{item.phone_number}</span>
                                        </DataTableRow>
                                        <DataTableRow>
                                            <span className="tb-lead">{item.age}</span>
                                        </DataTableRow>
                                        <DataTableRow className="nk-tb-col-tools">
                        ...
                        <PreviewAltCard>
                            {data.length > 0 ? (
                                ...
                                <div className="text-center">
                                    <span className="text-silent">Nothing to show</span>
                                </div>
                            )}
                        </PreviewAltCard>
                    </DataTable>
